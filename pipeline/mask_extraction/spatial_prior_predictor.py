...
def spatial_prior_predictor_undergeneration(input_mask, number_of_clusters_founded, desired_number_of_clusters, config, in_channels=9, out_channels=10):
    ...
    unet_model = torch.hub.load(repo_dir, 'unet',
           in_channels=in_channels, out_channels=out_channels, init_features=128, pretrained=False, source='local')
