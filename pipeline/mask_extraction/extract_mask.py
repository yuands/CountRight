...
from pipeline.mask_extraction.spatial_prior_predictor import spatial_prior_predictor_undergeneration, spatial_prior_predictor_overgeneration
...
def spatial_prior_predictor(sdxl_pipe, prompt, required_object_num, config, seed):
    ...
    if n_dbscan_clusters == required_object_num:
        ...
        if n_dbscan_clusters > required_object_num:
            ...
            object_masks = spatial_prior_predictor_undergeneration(torch_object_masks, number_of_clusters_founded=n_dbscan_clusters,
